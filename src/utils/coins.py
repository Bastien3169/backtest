...
COINS = [
    ...
    {"ticker": "USDT-EUR", "symbol": "USDT", "name": "Tether"},
    {"ticker": "XRP-EUR", "symbol": "XRP", "name": "XRP"},
    {"ticker": "BNB-EUR", "symbol": "BNB", "name": "BNB"},
    {"ticker": "USDC-EUR", "symbol": "USDC", "name": "USDC"},
    ...
    {"ticker": "BCH-EUR", "symbol": "BCH", "name": "Bitcoin Cash"},
    ...
    {"ticker": "DAI-EUR", "symbol": "DAI", "name": "Dai"},
    ...
    {"ticker": "CRO-EUR", "symbol": "CRO", "name": "Cronos"},
    {"ticker": "DOT-EUR", "symbol": "DOT", "name": "Polkadot"},
    {"ticker": "SKY-EUR", "symbol": "SKY", "name": "Sky"},
    {"ticker": "AAVE-EUR", "symbol": "AAVE", "name": "Aave"},
    {"ticker": "ICP-EUR", "symbol": "ICP", "name": "Internet Computer"},
    {"ticker": "ETC-EUR", "symbol": "ETC", "name": "Ethereum Classic"},
    {"ticker": "ALGO-EUR", "symbol": "ALGO", "name": "Algorand"},
    {"ticker": "QNT-EUR", "symbol": "QNT", "name": "Quant"},
    {"ticker": "ATOM-EUR", "symbol": "ATOM", "name": "Cosmos Hub"},
    {"ticker": "FIL-EUR", "symbol": "FIL", "name": "Filecoin"},
    {"ticker": "VET-EUR", "symbol": "VET", "name": "VeChain"},
    {"ticker": "BDX-EUR", "symbol": "BDX", "name": "Beldex"},
    {"ticker": "XDC-EUR", "symbol": "XDC", "name": "XDC Network"},
]
